<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="9.aspx.cs" Inherits="Web._9" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>9 RAM --AJAX Variabl Call JSON from Web Service</title>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <div id="myContent">
        <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%" cssclass="fancy fancy-green"  >
